...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MOLH-framework/MOLH.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/NotificationBannerSwift-framework/NotificationBannerSwift.framework"
